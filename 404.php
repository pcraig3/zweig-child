...
?>
	...
	--><div class="layout__item two-thirds palm-one-whole">
		<div class="frame frame--404 page-content">
...
echo do_shortcode( "[section_skeleton section_name='404' section_classes='error-404 not-found' section_header_classes='full-width' back_to_top='true' ] " . $html_string . '[/section_skeleton]');
